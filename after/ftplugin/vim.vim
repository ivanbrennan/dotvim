...
vmap <buffer> <silent>     <Plug>(ArticulateTag)  :tag     <C-R>=Vimcword()<CR><CR>
nmap <buffer> <silent>   <Plug>(ArticulateTjump)  :tjump   <C-R>=Vimcword()<CR><CR>
vmap <buffer> <silent>   <Plug>(ArticulateTjump)  :tjump   <C-R>=Vimcword()<CR><CR>
nmap <buffer> <silent> <Plug>(ArticulateTselect)  :tselect <C-R>=Vimcword()<CR><CR>
vmap <buffer> <silent> <Plug>(ArticulateTselect)  :tselect <C-R>=Vimcword()<CR><CR>
