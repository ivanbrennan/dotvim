...
" #############################################################################
" #############################################################################
" Sledgehammer override to get an upstream fix (see `FIX vimCommand` below
" #############################################################################
" #############################################################################
...
" ### FIX vimCommand ###
" Copied from https://github.com/neovim/neovim/blob/master/runtime/syntax/vim.vim
" Fixes issue where e.g. `contains=zParen` applies vimCommand syntax to `z`.
" The fix was to add `\>` to the end of the match pattern.
