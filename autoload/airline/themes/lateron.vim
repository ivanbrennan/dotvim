...
" Normal mode
let s:N1 = [ '#ffffff' , '#2e2d2a' , 255 , 235 ] " blackestgravel & snow
let s:N2 = [ '#b5dfff' , '#44403a' , 153, 237 ] " snow & deepgravel
let s:N3 = [ '#ffffff' , '#2e2d2a' , 255, 235 ] " dilutedpaint & darkgravel
